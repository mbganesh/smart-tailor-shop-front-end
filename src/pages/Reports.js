...
export default function Reports() {
  ...
  const onGenerateReportBtnClick = () => {
    if (fromDate === "" || toDate === "") {
      ...
      CustomAlert("Please Fill From Date and To Date!!", "", "warning")
      return
    }

    var dataToSend = { user: "admin", username: tokenData.userData.emailId, fromDate: fromDate + "T00:00:00.000Z", toDate: toDate + "T24:00:00.000Z" };
    axios
      .post(APIClient.API_BASE_URL + "/reportProcess/fromtodate", dataToSend,APIClient.API_HEADERS)
      .then((response) => {

        if (response.data.message.length === 0) {
          setHideTable("none")
          // alert("No Data Found")
          CustomAlert("No Data Found", "", "warning")
    ...
    <>
      {
        Object.keys(tokenData).length === 0 ?
          ...
          <div>
            ...
            >
              <div>
                <AppBarHead dataParent={{ appBtnColor: Colors.REPORT_MAIN_COLOR, appBtnText: "Report", userData: tokenData.userData }} />
              </div>
